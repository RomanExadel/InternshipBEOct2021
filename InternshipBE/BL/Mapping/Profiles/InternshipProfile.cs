    ...
    public class InternshipProfile : Profile
    {
        public InternshipProfile()
        {
            CreateMap<Internship, InternshipDTO>()
                ...
                .ForMember(dto => dto.RefusedCandidatesCount, src => src.MapFrom(entity => entity.Candidates.Where(x => x.StatusType == CandidateStatusType.Refused)
                .Count()))
                .ForMember(dto => dto.GraduatedCandidatesCount, src => src.MapFrom(entity => entity.Candidates.Where(x => x.StatusType == CandidateStatusType.Graduated).Count()))
