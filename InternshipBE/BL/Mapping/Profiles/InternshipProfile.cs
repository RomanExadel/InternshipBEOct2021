    ...
    public class InternshipProfile : Profile
    {
        public InternshipProfile()
        {
            CreateMap<Internship, InternshipDTO>()
                ...
                .ForMember(dto => dto.LanguageTypes, o => o.Ignore())
            ...
            CreateMap<InternshipDTO, Internship>()
                ...
                .ForMember(entity => entity.LanguageTypes, src => src.MapFrom(dto => Enum.Parse<LanguageType>(dto.LanguageTypes.ToString())))
