    ...
    public partial class SeedData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData("AspNetUsers",
                new[] { "Id", "Position", "BestContactTime", "UserName", "NormalizedUserName", "Email", "NormalizedEmail", "EmailConfirmed", "PasswordHash",
                ...
                new object[] { "3827e25d-8989-4881-9f25-807d14878c1b", "BA", DateTime.UtcNow, "Masha", "MASHA", "li@gmail.com", "LI@GMAIL.COM", false, "AQAAAAEAACcQAAAAEFrfBeLl7wG60Syi2unYkVUM4kp/0A8RAZdc51M8e/5GokOv0qDZF+aGBSVaSV6vag==",
                    "E5BBMDK3I3PX6MZCUDSP2TGQMJNHIOU7", "d722e70d-72fc-4f08-8fdc-afec3cef3c4f", "+123656787", false, false, null, true, 0 });

            migrationBuilder.InsertData("AspNetUsers",
                new[] { "Id", "Position", "BestContactTime", "UserName", "NormalizedUserName", "Email", "NormalizedEmail", "EmailConfirmed", "PasswordHash",
                    "SecurityStamp", "ConcurrencyStamp", "PhoneNumber", "PhoneNumberConfirmed", "TwoFactorEnabled", "LockoutEnd", "LockoutEnabled", "AccessFailedCount" },
                new object[] { "5516d40a-40bf-482c-8575-34a18478ac89", "Back", DateTime.UtcNow, "Maxim", "MAXIM", "max@gmail.com", "MAX@GMAIL.COM", false, "AQAAAAEAACcQAAAAEA/2Sy0cS1B+wbGk2R/Llrp6iuFzZjbJGu1Egoj2MYPPMaowQUgECV4Teg/K5xy/fg==",
                    "M3ZDA3WQP6J2ZVGKBIZHOE7GKC4BR2ZF", "2c39a495-1b10-49f9-926c-a40d078418ad", "+125656787", false, false, null, true, 0 });

            migrationBuilder.InsertData("AspNetUsers",
                new[] { "Id", "Position", "BestContactTime", "UserName", "NormalizedUserName", "Email", "NormalizedEmail", "EmailConfirmed", "PasswordHash",
                    "SecurityStamp", "ConcurrencyStamp", "PhoneNumber", "PhoneNumberConfirmed", "TwoFactorEnabled", "LockoutEnd", "LockoutEnabled", "AccessFailedCount" },
                new object[] { "57f2fe4e-64af-40b4-a279-5af5f1db8a8a", "Front", DateTime.UtcNow, "Dasha", "DASHA", "user@example.com", "USER@EXAMPLE.COM", false, "AQAAAAEAACcQAAAAEEVFxbsq/jnZ4avRoKtiCKb4QPzojCZDr6y9N3exNngtHExLdISgHDxhvprupVr9iQ==",
                    "YZYNYT3QR6FM5GVYL4VRT3EX3RIOZIFC", "09fb73b8-aab6-4ff4-a27b-4426a8b73570", "+325656787", false, false, null, true, 0 });

            migrationBuilder.InsertData("AspNetUsers",
                new[] { "Id", "Position", "BestContactTime", "UserName", "NormalizedUserName", "Email", "NormalizedEmail", "EmailConfirmed", "PasswordHash",
                    "SecurityStamp", "ConcurrencyStamp", "PhoneNumber", "PhoneNumberConfirmed", "TwoFactorEnabled", "LockoutEnd", "LockoutEnabled", "AccessFailedCount" },
                new object[] { "ff8a8331-c30a-4a6c-8860-0b49c533aa2c", "PO", DateTime.UtcNow, "Alexandr", "ALEXANDR", "admin@gmail.com", "ADMIN@GMAIL.COM", false, "AQAAAAEAACcQAAAAEK+m9ZBEt0HpxkxRafiiKjUsm1GShqzdyFWgzC1tGIApjSTzcLx49pKc1wIKrgN0tg==",
